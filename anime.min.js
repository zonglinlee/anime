...
a})}function d(){g.reversed=!g.reversed;m.forEach(function(a){return a.reversed=g.reversed})}function c(a){return g.reversed?g.duration-a:a}function e(a){for(var b=0,c=g.animations,d=c.length;b<d;){var e=c[b],h=e.animatable,f=e.tweens,l=f.length-1,k=f[l];l&&(k=C(f,function(b){return a<b.end})[0]||k);f=Math.min(Math.max(a-k.start-k.delay,0),k.duration)/k.duration;var n=isNaN(f)?1:k.easing(f);f=k.to.strings;var q=k.round;l=[];var t=k.to.numbers.length,m=void 0;for(m=0;m<t;m++){var r=void 0;r=k.to.numbers[m];
var p=k.from.numbers[m];r=k.isPath?fa(k.value,n*r):p+n*(r-p);q&&(k.isColor&&2<m||(r=Math.round(r*q)/q));l.push(r)}if(k=f.length)for(m=f[0],n=0;n<k;n++)q=f[n+1],t=l[n],isNaN(t)||(m=q?m+(t+q):m+(t+" "));else m=l[0];oa[e.type](h.target,e.property,m,h.transforms);e.currentValue=m;b++}g.currentTime=a;g.progress=a/g.duration*100}function h(a){if(g[a])g[a](g)}function f(){g.remaining&&!0!==g.remaining&&g.remaining--}function n(a){var l=g.duration,n=g.delay,t=c(a);if(m)if(t>=g.currentTime)for(var p=0;p<v;p++)m[p].seek(t-
m[p].timelineOffset);else for(p=v;p--;)m[p].seek(t-m[p].timelineOffset);if(t>=n||!l)g.began||(g.began=!0,h("begin")),t<=g.endDelay&&h("run");if(t>n&&t<l)e(t);else if(t<=n&&0!==g.currentTime&&(e(0),g.reversed&&f()),t>=l&&g.currentTime!==l||!l)e(l),g.reversed||f();h("update");a>=l&&(k=0,g.remaining?(q=r,"alternate"===g.direction&&d()):(g.paused=!0,g.completed||(g.completed=!0,h("complete"),"Promise"in window&&(w(),x=b()))))}a=void 0===a?{}:a;var q=0,k=0,r=0,m,v=0,w=null,x=b(),g=ma(a);g.reset=function(){var a=
g.direction,b=g.loop;g.currentTime=0;g.progress=0;g.paused=!0;g.began=!1;g.completed=!1;g.reversed="reverse"===a;g.remaining="alternate"===a&&1===b?2:b;m=g.children;for(a=v=m.length;a--;)g.children[a].reset();e(0)};g.tick=function(a){r=a;q||(q=r);n((r+(k-q))*p.speed)};g.seek=function(a){n(c(a))};g.pause=function(){g.paused=!0};g.play=function(){g.paused&&(g.paused=!1,q=0,k=c(g.currentTime),u.push(g),B||pa())};g.reverse=function(){d();q=0;k=c(g.currentTime)};g.restart=function(){g.pause();g.reset();
g.play()};g.goTo=function(a,b){var c=g.states.default;a=A(g.states[a],c);p.remove(c.targets);c=p(a);c.play();b&&c.seek(c.duration)};g.switchTo=function(a){g.goTo(a,!0)};g.finished=x;g.reset();g.startTime&&n(g.startTime-g.duration*Math.floor(g.startTime/g.duration));g.autoplay&&g.animations.length&&g.play();return g}function Y(a,b){for(var d=b.length;d--;)L(a,b[d].animatable.target)&&b.splice(d,1)}var na={update:void 0,begin:void 0,run:void 0,complete:void 0,loop:1,direction:"normal",autoplay:!0,startTime:0,
timelineOffset:0},X={duration:1E3,delay:0,endDelay:0,easing:"easeOutQuad",round:0},ea="translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skew skewX skewY perspective".split(" "),f={arr:function(a){return Array.isArray(a)},obj:function(a){return-1<Object.prototype.toString.call(a).indexOf("Object")},pth:function(a){return f.obj(a)&&a.hasOwnProperty("totalLength")},svg:function(a){return a instanceof SVGElement},dom:function(a){return a.nodeType||f.svg(a)},str:function(a){return"string"===
