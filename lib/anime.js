...
function convertPxToUnit(el, value, unit) {
  ...
  var parentEl = el.parentNode || document.body;
...
function anime(params) {
  ...
  instance.animateTo = function(stateName, paramsOverrides, bypassAnimation) {
    if ( paramsOverrides === void 0 ) paramsOverrides = {};

    var nextState = instance.states[stateName];
    var defaultState = instance.states.default;
    var params = mergeObjects(paramsOverrides, mergeObjects(nextState, defaultState));
