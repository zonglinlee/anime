...
var is = {
  ...
  key: function (a) { return !defaultInstanceSettings.hasOwnProperty(a) && !defaultTweenSettings.hasOwnProperty(a) && a !== 'targets' && a !== 'keyframes' && a !== 'states'; }
};
...
function flattenKeyframes(keyframes) {
  var propertyNames = filterArray([].concat( new Set(flattenArray(keyframes.map(function (key) { 
    return Object.keys(key).map(function (p) { if (is.key(p)) { return p } }); 
